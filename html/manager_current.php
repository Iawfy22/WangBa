...
<head>
    ...
    <title>管理员主页</title>
    <link rel="stylesheet" href="../css/manager_current.css">
</head>
<body>
<!-- 顶部栏 -->
<div class="header">
...
<div class="main-container">
    ...
    <div class="content">
        ...
        $sql = "SELECT * FROM manager_info order by manager_id ASC";
        $result = mysqli_query($conn, $sql);
        while($row = mysqli_fetch_assoc($result)){
            echo "<tr><td>". $row['manager_name'] ."</td><td>". $row['job'] ."</td><td>". $row['phone'] ."</td></tr>";
        }
        ?>
        </table>
