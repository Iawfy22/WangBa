...
<div class="main-container">
    ...
    <div class="content">
        ...
        ?>
        <form method="post" action="../backend/manager_info_modify.php">
            <table>
                <tr>
                    <td><label>昵称：</label></td>
                    <td><input type="text" name="manager_name" placeholder="<?php echo $row['manager_name'];?>"></td>
                </tr>
                <tr>
                    <td><label>联系方式：</label></td>
                    <td><input type="text" name="phone" placeholder="<?php echo $row['phone'];?>"></td>
                </tr>
                <tr>
                    <td><label>身份证号：</label></td>
                    <td><input type="text" name="manager_id" placeholder="<?php echo $row['manager_id'];?>"></td>
                </tr>
                <tr>
