...
<div class="main-container">
    ...
    <div class="content">
        ...
        {
        ?>
            <form action="../backend/add_manager.php" method="post">
                <table>
                    <tr>
                        <td width="150px"><label>管理员名称：</label></td>
                        <td><input type="text" name="manager_name"></td>
                    </tr>
                    <tr>
                        <td><label>管理员密码：</label></td>
                        <td><input type="password" name="password" placeholder='初始密码为123456'></td>
                    </tr>
                    <tr>
